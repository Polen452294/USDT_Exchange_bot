...
Ниже показан пример полного сценария взаимодействия с ботом: выбор направления обмена, ввод суммы, выбор офиса, подтверждение заявки и работа дожимов.

<p align="center">
  <img src="./assets/demo.gif" alt="Пример работы USDT Exchange Bot" width="260">
</p>
